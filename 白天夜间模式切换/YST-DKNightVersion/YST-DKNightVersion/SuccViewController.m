...
- (void)viewDidLoad {
   ...
   self.button1.frame = CGRectMake(100, 400, 100, 40);
    self.button1.backgroundColor =[UIColor redColor];
    [self.view addSubview:self.button1];
    [self.button1 setTitle:@"back" forState:(UIControlStateNormal)];
    [self.button1 addTarget:self action:@selector(back) forControlEvents:(UIControlEventTouchUpInside) ];
