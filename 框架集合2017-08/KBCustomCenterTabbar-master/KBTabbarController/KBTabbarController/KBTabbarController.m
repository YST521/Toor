...
@interface KBTabbarController ()<UITabBarDelegate,UITabBarControllerDelegate>
...
- (void)viewDidLoad {
    ...
    [self addChildController:avc title:@"add" imageName:@"" selectedImageName:@"" navVc:[UINavigationController class]];
