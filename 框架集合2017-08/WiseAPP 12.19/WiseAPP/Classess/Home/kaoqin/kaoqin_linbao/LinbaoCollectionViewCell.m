...
@implementation LinbaoCollectionViewCell
...
-(void)creadView{
    ...
    self.iconImageView.frame = CGRectMake((self.bgimageView.width-20)/2, PROPORTION_HIGHT(13), PROPORTION_WIDTH(20),  PROPORTION_HIGHT(20));
