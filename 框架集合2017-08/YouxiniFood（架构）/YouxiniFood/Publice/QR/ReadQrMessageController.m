...
- (void)creatNav{
    ...
    la.frame = CGRectMake(0, 20, SceneWidth, 44);
    
    self.naTitle = [[UILabel alloc]init];
    self.naTitle.frame = CGRectMake(la.width*0.25,6, 60, 23.0f);
  
    self.naTitle.textColor =[UIColor whiteColor];
    self.naTitle.textAlignment = NSTextAlignmentCenter;
    self.naTitle.font = [UIFont systemFontOfSize:18];
    [la addSubview: self.naTitle];
    self.naTitle.text  = @"扫一扫";
    self.naTitle.textColor =NaTitleColor;
