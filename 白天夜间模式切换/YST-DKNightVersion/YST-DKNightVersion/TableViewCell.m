...
//        self.button.layer.borderColor = [UIColor redColor].CGColor;
        ...
        self.separatorImageView = [[UIImageView alloc]init];
        self.separatorImageView.frame =CGRectMake(0, 0, 50, 50);
        self.separatorImageView.center =self.button.center;
//        self.separatorImageView.image =[UIImage imageNamed:@"normal1"];
              self.separatorImageView.dk_imagePicker = DKImagePickerWithNames(@"normal", @"night", @"normal1");
...
- (void)layoutSubviews {
    ...
    self.separatorImageView.center =self.button.center;
    // 几种方式设置
//    self.separatorImageView.dk_imagePicker = [DKImage pickerWithImageName:@"normal1"];
