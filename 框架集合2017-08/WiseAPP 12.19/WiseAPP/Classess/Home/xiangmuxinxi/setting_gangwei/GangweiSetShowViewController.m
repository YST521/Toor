//
//  GangweiSetShowViewController.m
//  WiseAPP
//
...
@interface GangweiSetShowViewController ()@property(nonatomic,strong)UIView* bgView;
...
@implementation GangweiSetShowViewController
...
//    [self.collectionView registerClass:[UICollectionViewCell class] forCellWithReuseIdentifier:@"cell"];
    ...
    //赋值
    self.titleLa.text = [NSString stringWithFormat:@"%@",self.model.post];
    self.contentLa.text =[NSString stringWithFormat:@"%@",self.model.jobassignment];
    
}

-(void)delegateAction:(UIButton*)sender{
    
    [self delegateGangweiNeedID: self.model.gangweiID];
...
////        [imagesArray addObject: dic[@"image"]];
////    }
////    
...
//    for (NSDictionary*dic in self.model.image) {
//        
//        [cellimage sd_setImageWithURL:[NSURL URLWithString: [self urlStringWithImageUrl:dic[@"image"]]] placeholderImage:[UIImage imageNamed:@"home_head_image"]];
//    }
//    
