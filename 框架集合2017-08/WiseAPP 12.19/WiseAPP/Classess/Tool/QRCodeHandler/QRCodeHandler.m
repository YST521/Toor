...
//        UIAlertController*alerVC= [UIAlertController alertControllerWithTitle:@"提示" message:@"摄像头不可用" preferredStyle:( UIAlertControllerStyleAlert)];
//        UIAlertAction*al= [UIAlertAction actionWithTitle:@"知道了" style:(UIAlertActionStyleDefault) handler:nil];
//        [alerVC addAction:al];
