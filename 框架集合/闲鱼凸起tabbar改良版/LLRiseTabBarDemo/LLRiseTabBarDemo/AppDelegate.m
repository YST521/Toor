...
#import "DouYunNavigaionController.h"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    DouYunNavigaionController *homeNV = [[DouYunNavigaionController alloc] initWithRootViewController:homeViewController];
    
	LLSameCityViewController *sameCityViewController = [[LLSameCityViewController alloc] init];
    DouYunNavigaionController *sameCityNV = [[DouYunNavigaionController alloc] initWithRootViewController:sameCityViewController];
    
	LLMessageViewController *messageViewController = [[LLMessageViewController alloc] init];
    DouYunNavigaionController *messageNV = [[DouYunNavigaionController alloc] initWithRootViewController:messageViewController];
    
	LLMineViewController *mineViewController = [[LLMineViewController alloc] init];
    DouYunNavigaionController *mineViewNV = [[DouYunNavigaionController alloc] initWithRootViewController:mineViewController];
    
    LastViewController*lasctVC = [[LastViewController alloc]init];
    DouYunNavigaionController *lastNV = [[DouYunNavigaionController alloc] initWithRootViewController: lasctVC];
	
	UITabBarController *tabBarController = [[UITabBarController alloc] init];
	tabBarController.viewControllers = @[homeNV, sameCityNV, lastNV,messageNV, mineViewNV];
    ...
    tabBar.tabBarItemAttributes = @[@{kLLTabBarItemAttributeTitle : @"首页", kLLTabBarItemAttributeNormalImageName : @"home_normal", kLLTabBarItemAttributeSelectedImageName : @"home_highlight", kLLTabBarItemAttributeType : @(LLTabBarItemNormal)},
                                    ...
                                    @{kLLTabBarItemAttributeTitle : @"发布", kLLTabBarItemAttributeNormalImageName : @"tabbar-icon_message", kLLTabBarItemAttributeSelectedImageName : @"tabbar-icon_message", kLLTabBarItemAttributeType : @(LLTabBarItemNormal)},
