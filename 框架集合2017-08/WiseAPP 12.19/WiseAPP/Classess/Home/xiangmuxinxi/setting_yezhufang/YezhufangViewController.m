...
@interface YezhufangViewController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,ClipViewControllerDelegate,UITextViewDelegate,passTimHMvalue>
{
...
-(void)addView{
    ...
    [self.tableview registerClass:[YezhuaddCell class] forCellReuseIdentifier:yezhuCellID];
//add footView
        [self addFootView];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    YezhuaddCell*cell = [self.tableview dequeueReusableCellWithIdentifier:yezhuCellID];
//    if (self.nextPageType !=1) {
//        cell.rightLa.text=@"去设置";
//    }
    [cell getValueModel:self.model cellIndex:indexPath UPpage:self.nextPageType dataArray:self.dataArray];
