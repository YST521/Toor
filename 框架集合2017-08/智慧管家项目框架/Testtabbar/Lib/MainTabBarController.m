...
//  WiseAPP
//
//  Created by shanliang.yi on 16/10/9.
...
-(void)addChildViewController{
    ...
    [self addChildController:homeVC title:@"首页" imageName:@"tab1-heartshow" selectedImageName:@"tab1-heart" navVc:[RootUINavigationController class]];
    
    [self addChildController:addressVC title:@"通讯录" imageName:@"tab2-doctor" selectedImageName:@"tab2-doctorshow" navVc:[RootUINavigationController class]];
    
    [self addChildController:userVC title:@"应用" imageName:@"tab4-more" selectedImageName:@"tab4-moreshow" navVc:[RootUINavigationController class]];
    

    [self addChildController:myVC title:@"我的" imageName:@"tab5-file" selectedImageName:@"tab5-fileshow" navVc:[RootUINavigationController class]];
    
    //再加一个item会被挤到屏幕右侧
    [self addChildController:messageVC title:@"消息" imageName:@"" selectedImageName:@"" navVc:[RootUINavigationController class]];
